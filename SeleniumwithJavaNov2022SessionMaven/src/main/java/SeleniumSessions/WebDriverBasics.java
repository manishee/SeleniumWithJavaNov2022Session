...
public class WebDriverBasics {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// "C:\\mchugh\\Downloads\\chromedriver.exe");
		// Mac-->System.setProperty("webdriver.chrome.driver",
		...
		driver.quit();// NoSuchSessionException: Session ID is null. Using WebDriver after calling
						// quit()?
