...
public class Employee 
{
	...
	public static void main(String[] args) 
	{
		...
		String assets_sheetal[]=e1.getEmployeeAssets("Sheetal");
...
//		String assets_george[]=e1.getEmployeeAssets("George");
//		System.out.println("Total Assets " + assets_george.length);//4
//		
//		for(String g : assets_george) {
